...
const AboutUs: React.FC = () => {
  return (
    <section className="text-black flex flex-col bg-white py-20 text-3xl md:text-4xl">
      <div className="flex justify-center items-center mb-4"><a href="https://f1inschools.com" target="_f1inschools">
        <Image
      ...
      <div className="container mx-auto px-11">
        <p className="leading-tight max-w-5xl mx-auto text-3xl tracking-tight">
          <strong><Link legacyBehavior href="https://f1inschools.com"><a target="_blank"
            className="underline underline-offset-4 decoration-2">F1 in Schools</a></Link> is the world&apos;s largest STEM (Science, Technology, Engineering & Mathematics) Competition</strong> for
          school children between the age of 9 and
          19 wherein groups of 3-6 students are supposed to design, manufacture
          a miniature car out of the official F1 Model Block using CAD
          (Computer-Aided Design) / CAM (Computer-Aided Manufacturing) design
